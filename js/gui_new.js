...
function setup() {
  ...
  tr1 = createSelect();
  tr1.position(9*w/12,h/10+50);

  tr2 = createSelect();
  tr2.position(9*w/12,h/10+70);

  tr3 = createSelect();
  tr3.position(9*w/12,h/10+90);

  tr4 = createSelect();
  tr4.position(9*w/12,h/10+110);
...
function draw() {
  ...
  // main circle
  proportion = 1;
  TrackCircle(onsetsA,pulsesA,proportion, cl1, cl2);
  // second circle
  proportion = 0.7;
  TrackCircle(onsetsB,pulsesB,proportion, cl3, cl4);
  ...
  proportion = 1;
  ShuffleCircle(onsetsA,pulsesA,proportion,cl1,cl2)

  proportion = 0.7;
  ShuffleCircle(onsetsB,pulsesB,proportion,cl3,cl4)
